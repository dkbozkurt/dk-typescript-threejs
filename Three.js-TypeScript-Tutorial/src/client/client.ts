...
const mirrorBack1: Reflector = new Reflector(new THREE.PlaneGeometry(2, 2), {
...
const mirrorBack2: Reflector = new Reflector(new THREE.PlaneGeometry(2, 2), {
    color: new THREE.Color(0x7f7f7f),
    textureWidth: window.innerWidth * window.devicePixelRatio,
    textureHeight: window.innerHeight * window.devicePixelRatio,
})
...
const mirrorFront1: Reflector = new Reflector(new THREE.PlaneGeometry(2, 2), {
    color: new THREE.Color(0x7f7f7f),
    //clipBias: 0.003,
    textureWidth: window.innerWidth * window.devicePixelRatio,
    textureHeight: window.innerHeight * window.devicePixelRatio,
...
const mirrorFront2: Reflector = new Reflector(new THREE.PlaneGeometry(2, 2), {
    color: new THREE.Color(0x7f7f7f),
    //clipBias: 0.003,
    textureWidth: window.innerWidth * window.devicePixelRatio,
    textureHeight: window.innerHeight * window.devicePixelRatio,
